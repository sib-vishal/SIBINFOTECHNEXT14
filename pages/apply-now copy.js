    ...
    if (data && !data.error) {
      axios.post(`${CONSTANTS.API_URL}send-email-application`, {
        html: `
             ...
             <tr>
             <td colspan="2" style="background-color: #ddd; font-weight: bold; text-align: center;">
                 Job Details
             </td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Job type</td>
             <td style='padding:10px;'>${inputs.jobtype}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Post applied for</td>
             <td style='padding:10px;'>${inputs.postapplied}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Job location</td>
             <td style='padding:10px;'>${inputs.job_location}</td>
         </tr>
         <tr>
             <td colspan="2" style="background-color: #ddd; font-weight: bold; text-align: center;">
                 Personal Details
         ...
         <tr>
             <td style='padding:10px;' width='250'>First Name</td>
             <td style='padding:10px;'>${inputs.fname}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Last Name</td>
             <td style='padding:10px;'>${inputs.lname}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Gender</td>
             <td style='padding:10px;'>${inputs.gender}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Date of Birth</td>
             <td style='padding:10px;'>${inputs.dob}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Category</td>
             <td style='padding:10px;'>${inputs.category}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Marital Status</td>
             <td style='padding:10px;'>${inputs.marital}</td>
         </tr>
         <tr>
             <td colspan="2" style="background-color: #ddd; font-weight: bold; text-align: center;">
         ...
         <tr>
             <td style='padding:10px;' width='250'>Phone</td>
             <td style='padding:10px;'>${inputs.phone}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Mobile</td>
             <td style='padding:10px;'>${inputs.mobile}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Present Address</td>
             <td style='padding:10px;'>${inputs.pre_add}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Present City</td>
             <td style='padding:10px;'>${inputs.pre_city}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Present State</td>
             <td style='padding:10px;'>${inputs.pre_state}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Present Pincode</td>
             <td style='padding:10px;'>${inputs.pre_pincode}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Permanent Address</td>
             <td style='padding:10px;'>${inputs.perm_add}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Permanent City</td>
             <td style='padding:10px;'>${inputs.perm_city}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Permanent State</td>
             <td style='padding:10px;'>${inputs.perm_state}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Permanent Pincode</td>
             <td style='padding:10px;'>${inputs.perm_pincode}</td>
         </tr>
         <tr>
             <td colspan="2" style="background-color: #ddd; font-weight: bold; text-align: center;">
         ...
         <tr>
             <td style='padding:10px;' width='250'>Qualification</td>
             <td style='padding:10px;'>${inputs.qualification}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Total Experience</td>
             <td style='padding:10px;'>${inputs.total_ye} years ${inputs.total_me} months</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>IT Experience</td>
             <td style='padding:10px;'>${inputs.it_ye} years ${inputs.it_me} months</td>
         </tr>
         <tr>
             <td colspan="2" style="background-color: #ddd; font-weight: bold; text-align: center;">
                 Employment Details
         ...
         <tr>
             <td style='padding:10px;' width='250'>Current Salary</td>
             <td style='padding:10px;'>${inputs.current_salary}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Expected Salary</td>
             <td style='padding:10px;'>${inputs.expect_salary}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Notice Period</td>
             <td style='padding:10px;'>${inputs.notice_period}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Earliest Joining Date</td>
             <td style='padding:10px;'>${inputs.join_date}</td>
         </tr>
         <tr>
             <td style='padding:10px;' width='250'>Current Job Status</td>
             <td style='padding:10px;'>${inputs.cur_jobsts}</td>
         </tr>
         <tr>
             <td colspan="2" style="background-color: #ddd; font-weight: bold; text-align: center;">
      ...
      <div key={divElements.length}>
        <div className="expmore_content">
          ...
          <div className="row">
            ...
            <Link>
              <span className="removeMore"><i className="fa fa-trash-alt"></i> Remove</span>
            </Link>
         </div> */}
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="innerBannerTitle venter">
                ...
                <p className="title mt-2 text-white text-center">
                        ...
                        <div className="contact-form">
                          ...
                          >
                            <div className="apply_form_box">
                              <p className="title">
                                Job <span className="text_red">details</span>
                              </p>
                              <div className="row">
                                <div className="form-group col-md-4  col-xs-12">
                                ...
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  >
                                    ...
                                    <option value="Business Development Executive Website Sales">
                                      Business Development Executive Website
                                      Sales
                                    </option>
                                    <option value="Client Servicing Executive">
                                    ...
                                    <option value="Digital Marketing Head">
                                      Digital Marketing Head
                                    </option>
                                    <option value="E-Commerce Listing Executive - Cataloger">
                                      E-Commerce Listing Executive - Cataloger
                                    </option>
                                    <option value="Executive Assistant to Director">
                                      Executive Assistant to Director
                                    </option>
                                    <option value="Front End Developer - Executive">
                                      Front End Developer - Executive
                                    </option>
                                    <option value="Front end Developer - Junior">
                                      Front end Developer - Junior
                                    </option>
                                    <option value="Front End Developer - Manager">
                                      Front End Developer - Manager
                                    </option>
                                    <option value="Front End Developer- Intern">
                                      Front End Developer- Intern
                                    </option>
                                    <option value="Front End Developer- Senior">
                                    ...
                                    <option value="Graphic Designer - Junior">
                                      Graphic Designer - Junior
                                    </option>
                                    <option value="Graphic Designer - Senior">
                                      Graphic Designer - Senior
                                    </option>
                                    <option value="Graphic Designer - Social Media">
                                      Graphic Designer - Social Media
                                    </option>
                                    <option value="HR Cum Admin Executive">
                                    ...
                                    <option value="MEAN Stack Developer - Executive">
                                      MEAN Stack Developer - Executive
                                    </option>
                                    <option value="MEAN Stack Developer - Junior">
                                      MEAN Stack Developer - Junior
                                    </option>
                                    <option value="MEAN Stack Developer - Senior">
                                      MEAN Stack Developer - Senior
                                    </option>
                                    <option value="Mobile App Developer">
                                      Mobile App Developer
                                    </option>
                                    <option value="Mobile App Developer - Junior">
                                      Mobile App Developer - Junior
                                    </option>
                                    <option value="Mobile App Developer- Intern">
                                      Mobile App Developer- Intern
                                    </option>
                                    <option value="Mobile App Developer-Unity">
                                      Mobile App Developer-Unity
                                    </option>
                                    <option value="PHP Developer">
                                      PHP Developer
                                    </option>
                                    <option value="PPC Executive - Junior">
                                      PPC Executive - Junior
                                    </option>
                                    <option value="PPC Executive - Senior">
                                      PPC Executive - Senior
                                    </option>
                                    <option value="PPC Manager">
                                      PPC Manager
                                    </option>
                                    <option value="SEO EXECUTIVE ">
                                      SEO EXECUTIVE{" "}
                                    </option>
                                    <option value="SEO Executive - Junior">
                                      SEO Executive - Junior
                                    </option>
                                    <option value="SEO Executive - Senior">
                                      SEO Executive - Senior
                                    </option>
                                    <option value="SEO Junior">
                                      SEO Junior
                                    </option>
                                    <option value="SEO Manager">
                                      SEO Manager
                                    </option>
                                    <option value="Social Media Executive">
                                      Social Media Executive
                                    </option>
                                    <option value="Social Media Executive - Junior">
                                      Social Media Executive - Junior
                                    </option>
                                    <option value="Social Media Executive - Senior">
                                      Social Media Executive - Senior
                                    </option>
                                    <option value="UI/UX Designer">
                                      UI/UX Designer
                                    </option>
                                    <option value="UI/UX Designer - Executive">
                                      UI/UX Designer - Executive
                                    </option>
                                    <option value="UI/UX Designer - Manager">
                                      UI/UX Designer - Manager
                                    </option>
                                    <option value="UI/UX Designer - Senior">
                                      UI/UX Designer - Senior
                                    </option>
                                    <option value="UI/UX Designer -Junior">
                                      UI/UX Designer -Junior
                                    </option>
                                    <option value="UI/UX Designer- Intern">
                                      UI/UX Designer- Intern
                                    </option>
                                    <option value="Web Developer -  Manager">
                                      Web Developer - Manager
                                    </option>
                                    <option value="Web Developer - Executive">
                                      Web Developer - Executive
                                    </option>
                                    <option value="Web Developer - Intern">
                                      Web Developer - Intern
                                    </option>
                                    <option value="Web Developer - Junior">
                                      Web Developer - Junior
                                    </option>
                                    <option value="Web Developer - Senior">
                                      Web Developer - Senior
                                    </option>
                                    <option value="Website Designer">
                                      Website Designer
                                    </option>
                                    <option value="Website Designer -Senior">
                                      Website Designer -Senior
                                    </option>
                                    <option value="Website Designer- Executive ">
                                      Website Designer- Executive{" "}
                                    </option>
                                    <option value="Website Designer- Intern">
                                      Website Designer- Intern
                                    </option>
                                    <option value="Website Designer- Junior">
                                      Website Designer- Junior
                                    </option>
                                    <option value="Website Designer- Manager">
                                    ...
                                    <option value="Wordpress Developer- Executive">
                                      Wordpress Developer- Executive
                                    </option>
                                    <option value="Wordpress Developer- Intern">
                                      Wordpress Developer- Intern
                                    </option>
                                    <option value="Wordpress Developer- Manager">
                            ...
                            <div className="apply_form_box">
                              <p className="title">
                                Personal{" "}
                                <span className="text_red">details</span>
                              </p>
                              <div className="row">
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  <div key={index}>
                                    <div className="row">
                                      ...
                                      <div className="form-group col-md-4  col-xs-12">
                                        ...
                                        <input
                                          type="text"
                                          name="acomp_level_exp"
                                          value={input.acomp_level_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                        />
                                    ...
                                    <div className="row">
                                      <div className="form-group col-md-4  col-xs-12">
                                        ...
                                        <input
                                          name="acomp_jtitle_exp"
                                          type="text"
                                          value={input.acomp_jtitle_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                        />
                                      ...
                                      <div className="form-group col-md-2  col-xs-12">
                                        <label>From</label>
                                        <select
                                          name="acomp_fyear_exp"
                                          value={input.acomp_fyear_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                          id=""
                                      ...
                                      <div className="form-group col-md-2  col-xs-12">
                                        <label>&nbsp;</label>
                                        <select
                                          name="acomp_fmonth_exp"
                                          value={input.acomp_fmonth_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                          id=""
                                      ...
                                      <div className="form-group col-md-2  col-xs-12">
                                        <label>To</label>
                                        <select
                                          name="acomp_tyear_exp"
                                          value={input.acomp_tyear_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                          id=""
                                      ...
                                      <div className="form-group col-md-2  col-xs-12">
                                        <label>&nbsp;</label>
                                        <select
                                          name="acomp_tmonth_exp"
                                          value={input.acomp_tmonth_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                          id=""
                                      ...
                                      <div className="form-group col-md-12  col-xs-12">
                                        ...
                                        <textarea
                                          name="acomp_jdesc_exp"
                                          value={input.acomp_jdesc_exp}
                                          onChange={(event) =>
                                            handleExperienceChange(index, event)
                                          }
                                        ></textarea>
                              ...
                              <div className="row">
                                <div className="form-group col-md-6 col-sm-12 col-xs-12">
                                  ...
                                  >
                                    ...
                                    <option value="Naukri.com">
                                      Naukri.com
                                    </option>
                                    <option value="Indeed.com">
                                      Indeed.com
                                    </option>
                                    <option value="Instahyer.com">
                                      Instahyer.com
                                    </option>
                                    <option value="SIB Infotech Employee">
                                      SIB Infotech Employee
                                    </option>
                                ...
                                <div
                                  className="form-group col-md-6 col-sm-12 col-xs-12"
                                  style={{ display: "none" }}
                                ></div>
                              </div>
                            </div>
                            <div
                              className="apply_form_box"
                              style={{ display: "none" }}
                            >
                              <p className="title">
                                Web{" "}
                                <span className="text_red">development</span>
                              </p>
                              <div className="row">
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  <div
                                    className="ms-parent form-control"
                                    style={{ width: "100%" }}
                                  >
                                    ...
                                    <div className="ms-drop bottom">
                                      ...
                                      <ul style={{ maxHeight: "150px" }}>
                                        <li className="ms-select-all">
                                          <label>
                                            <input
                                              type="checkbox"
                                              data-name="selectAlllanguages[]"
                                            />{" "}
                                            [Select all]
                                          </label>
                                        </li>
                                      ...
                                      <ul style={{ maxHeight: "150px" }}>
                                        ...
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItemframeworks[]"
                                              value="Angular JS"
                                            />
                                ...
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  >
                                    ...
                                    <option value="Vtiger CRM">
                                      Vtiger CRM
                                    </option>
                                    <option value="Sugar CRM">Sugar CRM</option>
                                    <option value="Microsoft CRM">
                                      Microsoft CRM
                                    </option>
                                      ...
                                      <ul style={{ maxHeight: "150px" }}>
                                        <li className="ms-select-all">
                                          <label>
                                            <input
                                              type="checkbox"
                                              data-name="selectAlldevelopment[]"
                                            />{" "}
                                            [Select all]
                                          </label>
                                        </li>
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItemdevelopment[]"
                              ...
                              <div className="row">
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  >
                                    ...
                                    <option value="Windows Development">
                                      Windows Development
                                    </option>
                                    <option value="Android Development">
                                      Android Development
                                    </option>
                                    <option value="Blackberry Applications">
                                        ...
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItemapps[]"
                                              value="Blackberry Applications"
                                            />
                                            <span>Blackberry Applications</span>
                                          </label>
                                        </li>
                                        <li className="ms-no-results">
                                          No matches found
                            ...
                            >
                              <p className="title">
                                Digital{" "}
                                <span className="text_red">Marketing</span>
                              </p>
                              <div className="row">
                                <div className="form-group col-md-4  col-xs-12">
                                  <label for="">
                                  ...
                                  <select
                                    ...
                                    style={{ display: "none" }}
                                  >
                                    <option value="On Page Optimization">
                                      On Page Optimization
                                    </option>
                                    <option value="Off Page Optimization">
                                      Off Page Optimization
                                    </option>
                                    <option value="Directory Submission">
                                      Directory Submission
                                    </option>
                                    <option value="Artcile Submission">
                                      Artcile Submission
                                    </option>
                                    <option value="Social Book Marking">
                                      Social Book Marking
                                    </option>
                                    <option value="Infographics">
                                      Infographics
                                    </option>
                                    <option value="You Tube Ads">
                                      You Tube Ads
                                    </option>
                                  </select>
                                  <div
                                        ...
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItemseo[]"
                                              value="Artcile Submission"
                                            />
                                            <span>Artcile Submission</span>
                                          </label>
                                        </li>
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItemseo[]"
                                              value="Social Book Marking"
                                            />
                                            <span>Social Book Marking</span>
                                          </label>
                                        </li>
                                        <li className="">
                                          <label className="">
                                ...
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  >
                                    ...
                                    <option value="Facebook Advertsiing">
                                      Facebook Advertsiing
                                    </option>
                                    ...
                                    <option value="Pin Intrest">
                                      Pin Intrest
                                    </option>
                                    <option value="Snap Chat Marketing">
                                      Snap Chat Marketing
                                    </option>
                                    <option value="You Tube Marketing">
                                      You Tube Marketing
                                    </option>
                                        ...
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItempay[]"
                                              value="Facebook Advertsiing"
                                            />
                                            <span>Facebook Advertsiing</span>
                                          </label>
                                        </li>
                                        <li className="">
                                          <label className="">
                                        ...
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItempay[]"
                                              value="Snap Chat Marketing"
                                            />
                                            <span>Snap Chat Marketing</span>
                                          </label>
                                        </li>
                                        <li className="">
                                          <label className="">
                                            <input
                                              type="checkbox"
                                              data-name="selectItempay[]"
                                              value="You Tube Marketing"
                                            />
                                            <span>You Tube Marketing</span>
                                          </label>
                                        </li>
                                        <li className="">
                                          <label className="">
                                ...
                                <div className="form-group col-md-4  col-xs-12">
                                  ...
                                  >
                                    ...
                                    <option value="Twitter Marketing">
                                      Twitter Marketing
                                    </option>
