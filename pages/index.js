            ...
            <div className="col-lg-7 pe-lg-4">
              <div className="drivenLeft">
                ...
                <ul>
                  ...
                  <li><Link href="/pay-per-click-ppc-management-services">PPC Management</Link></li>
                  <li><Link href="/search-engine-optimization-seo-services">Search Engine Optimization</Link></li>
                  <li><Link href="/social-media-marketing-services">Social Media Marketing</Link></li>
                  <li><Link href="/social-media-optimization-services">Social Media Optimization</Link></li>
          ...
          <div className="servicesWeb">
            <div className="inlineService">
              <div className="itemServiceLine" data-background="url(assets/images/bg/web-design.jpg)">
                ...
                <Link href="/website-designing-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine"  data-background="url(assets/images/bg/seo.jpg)">
                ...
                <Link href="/search-engine-optimization-seo-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine"  data-background="url(assets/images/bg/offshore.jpg)">
                ...
                <Link href="/search-engine-optimization-outsourcing-seo-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine borderTop"  data-background="url(assets/images/bg/web-development.jpg)">
                ...
                <Link href="/website-development-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine borderTop"  data-background="url(assets/images/bg/mobile-app.jpg)">
                ...
                <Link href="/mobile-application-development-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine borderTop"  data-background="url(assets/images/bg/software-development.jpg)">
                ...
                <Link href="/software-development-services" className="linkService">Read More</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-3 text-end">
              <div className="buttonRight">
                <Link href="/contact-us" className="btnThemeRed">Get a Quote</Link>
              </div>
            </div>
          </div>
          <hr/>
    ...
    <section className="bgAction">
      <div className="containerFull">
        <div className="d-flex align-items-center justify-content-between home_cta">
          ...
          <Link href="tel: +91-9222260000" className="btnAction">Let's Talk Growth <i className="bi bi-arrow-right"></i></Link>
        </div>
      </div>
    </section>
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="leftFAQ">
                ...
                <div>
                  <Link href="tel: +91-9222260000" className="btnTheme mt-4"><i className="fa fa-phone"></i>  +91-9222260000</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-7">
              <div className="faqRight ps-lg-4">
                ...
                <div className="text-end">
                  <Link href="#" className="link mt-2">See All <i className="fa fa-caret-right"></i></Link>
                </div>
              </div>
            </div>
          </div>
